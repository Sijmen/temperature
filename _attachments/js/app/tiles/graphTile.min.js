GraphTile=Class.create(Tile,{initialize:function($super,a,d,b){var c=this;$super(a,b);this.oGraph={};this.oOptions=$.extend(true,{timespan:300,smoothScale:1,timespanType:"time",serie:{name:"serie1",data:[],color:"#c05020"},graphOptions:{min:"auto",renderer:"area"}},b);
