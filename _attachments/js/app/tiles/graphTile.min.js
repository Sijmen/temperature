...
this.xAxis.render();this.oGraph.render();this.bRendered=true;},vUpdate:function($super,b,a){$super();var c=this;if(c.oUpdateTimeout){clearInterval(c.oUpdateTimeout);
}if(typeof b==="undefined"||!b){c.oUpdateTimeout=setTimeout(function(){c.vUpdate(true);},10);}else{if(this.bRendered){this.oGraph.render();}else{this.vRender();
}}},vSetSmooth:function(a){this.oOptions.smoothScale=a;},vResize:function(){if(typeof this.oGraph!=="undefined"&&this.oGraph!==null){this.oGraph.configure({width:$(this.sSelector).parent().innerWidth()});
