...
},10);}else{if(this.bRendered){this.oGraph.render();}else{this.vRender();}}},vSetSmooth:function(a){this.oOptions.smoothScale=a;},vResize:function(){if(typeof this.oGraph!=="undefined"&&this.oGraph!==null){this.oGraph.configure({width:$(this.sSelector).parent().innerWidth()});
