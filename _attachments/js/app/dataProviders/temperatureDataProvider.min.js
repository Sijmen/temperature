...
b.vOnNewGraphData({y:oDoc.temperature,x:Math.round(oDoc.time/1000)});b.vSetupChanges(f.last_seq);}});}});},vRequestGraphRangeData:function($super,c,a){$super(c);
...
}});a.iLastChange=b.last_seq;a.vSetupChanges(b.last_seq);}},vSetupChanges:function(a){if(!this.bChangesRunning){this.oChangeHandler=this.oDB.changes(a,{include_docs:true,filter:this.oOptions.filter,dev:this.oOptions.sensor_id});
